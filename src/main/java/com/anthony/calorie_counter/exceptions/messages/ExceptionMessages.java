...
public class ExceptionMessages {
    ...
    public static final String UNAUTHORIZED_TO_DELETE_DATA = "You have no authorization to delete data with id: ";
    ...
    public static final String INVALID_REFERENCED_DATA = "Invalid referenced data: ";
